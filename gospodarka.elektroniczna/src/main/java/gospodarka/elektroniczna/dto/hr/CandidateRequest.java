...
public class CandidateRequest extends AbstractHrUser implements Serializable {
    ...
    public CandidateRequest(String jobName, String requiredExperience, String goodToKnownExperience) {
        super();
