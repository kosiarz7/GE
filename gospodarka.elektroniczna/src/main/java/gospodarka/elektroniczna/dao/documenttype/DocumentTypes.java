...
public enum DocumentTypes {
   ...
   DEFECTIVE_ELEMENT, INDUSTRIAL_ACCIDENT, MONTHLY_SUMMARY_OF_PRODUCTION_LINE, ORDER, TIME_SHEET, NEW_VEHICLE,
    INTERNAL_ISSUE,  INTERNAL_ADOPTION, EXTERNAL_ISSUE, EXTERNAL_ADOPTION,  ORDER_CONFIRMATION, PRODUCTION_ORDER,
    INVOICE, COLLECT_CAR, DAMAGED_CAR, REPAIR_COST_ESTIMATION, REPLACEMENT_PART_ORDER, WARRANTY_REPAIR,
    ORDER_CARD, ORDER_INVOICE, DAILY_WORK_REPORT, TEST_DRIVE_REPORT, SERVICE_ORDER_CARD;
