...
CREATE TABLE IF NOT EXISTS DOCUMENT_HEADER (
	ID INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS CURRENT_DOCUMENTS (
	...
	PRIMARY KEY (ID),
	FOREIGN KEY CURRENT_DOCUMENTS_00_HEADER_ID_FK(HEADER_ID) REFERENCES DOCUMENT_HEADER(ID),
...
CREATE TABLE IF NOT EXISTS ARCHIVAL_DOCUMENTS (
	...
	CONTENT LONGBLOB NOT NULL,
	PRIMARY KEY (ID),
	FOREIGN KEY ARCHIVAL_DOCUMENTS_00_HEADER_ID_FK(HEADER_ID) REFERENCES DOCUMENT_HEADER(ID),
