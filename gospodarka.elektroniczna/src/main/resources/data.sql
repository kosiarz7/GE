...
('DEFECTIVE_ELEMENT'), 
('INDUSTRIAL_ACCIDENT'),
('MONTHLY_SUMMARY_OF_PRODUCTION_LINE'), 
('ORDER'), 
('TIME_SHEET'), 
('NEW_VEHICLE'),
('INTERNAL_ISSUE'), 
